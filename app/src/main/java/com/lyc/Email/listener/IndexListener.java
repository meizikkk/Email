...
public class IndexListener implements View.OnClickListener{
    ...
    public IndexListener(IndexActivity indexActivity, String msg, FrameLayout frameLayout) {
...
//            }
        ...
        for (int i = 0; i < IndexActivity.data.length(); i++) {
            if (v.getId() == 800 + i) {
                Intent intent = new Intent(indexActivity, DetailActivity.class);
